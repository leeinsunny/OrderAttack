...
import com.example.orderattack.databinding.ActivityBurgerBeefBinding

class Burger_beef : AppCompatActivity() {
    private lateinit var binding : ActivityBurgerBeefBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_burger_beef)


        binding = DataBindingUtil.setContentView(this, R.layout.activity_burger_beef)
        ...
        binding.betodi.setOnClickListener {
            val intent = Intent(this, setornot::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
            startActivity(intent)
        }
