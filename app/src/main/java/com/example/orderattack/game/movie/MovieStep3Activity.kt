...
class MovieStep3Activity : AppCompatActivity(), OnDateClickListener, OnShowtimeClickListener, MovieItemClickListener {
    ...
    private fun getResourceIdByName(resourceName: String, resourceType: String): Int {
    ...
    private fun checkShowtimes(cinemaItem: CinemaItem, dialogView: View) {
        ...
        if (selectedDateResId == 0)
            selectedDateResId = getResourceIdByName("1", "drawable")
