...
import com.example.orderattack.databinding.ActivityBurgerChickenBinding

class Burger_chicken : AppCompatActivity() {

    private lateinit var binding: ActivityBurgerChickenBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_burger_chicken)


        binding = DataBindingUtil.setContentView(this, R.layout.activity_burger_chicken)
