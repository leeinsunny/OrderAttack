...
public abstract class ActivityLoginBinding extends ViewDataBinding {
  @NonNull
  public final EditText emailareainlogin;

  @NonNull
  public final Button loginBtninlogin;

  @NonNull
  public final EditText pwareainlogin;

  protected ActivityLoginBinding(Object _bindingComponent, View _root, int _localFieldCount,
      EditText emailareainlogin, Button loginBtninlogin, EditText pwareainlogin) {
    super(_bindingComponent, _root, _localFieldCount);
    this.emailareainlogin = emailareainlogin;
    this.loginBtninlogin = loginBtninlogin;
    this.pwareainlogin = pwareainlogin;
  }
